...
const EditFirm = lazy(() => import("./jsx/components/Dashboard/Profile/EditFirm.js"));
const Quote = lazy(() => import("./jsx/components/Dashboard/Profile/Quote.js"));
  ...
  useEffect(() => {
    ...
    let routes = (
        <Switch>
            ...
            <Route path='/Dashboard/Profile' component={EditFirm} />
            
            <Route path='/Dashboard/Profile' component={Quote} />
