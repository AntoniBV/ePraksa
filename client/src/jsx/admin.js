...
import EditFirm from "./components/Dashboard/Profile/EditFirm";
import EditQuote from "./components/Dashboard/Profile/EditQuote";

import Quote from "./components/Dashboard/Profile/Quote.js";
...
import Internship from "../mentor/components/AppsMenu/Internship/Internship";
...
const Markup = () => {
    ...
    const routes = [
        ...
        { url: "admin/quote", component: Quote },
        ...
        { url: "admin/prakse", component: Internship },
        ...
        { url: "admin/firma/:id", component: EditFirm },
        { url: "admin/quote/:id", component: EditQuote },
