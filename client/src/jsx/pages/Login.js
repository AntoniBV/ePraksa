...
//Custom functions
import login from "./loginLib/loginFunctions"
        ...
        fetch(
            ...
            .then((data) => {
                if (data.error) {
                    ...
                    const idCarry = login.getId[data.role];
                    data.role = login.getRole[data.role];
                    Cookies.set("ROLE", data.role);
                    if (idCarry) {
                        Cookies.set("ID", data[idCarry]);
                        Cookies.set("NAME", data.FirstName || data.Firstname || data.Name);
                    }
